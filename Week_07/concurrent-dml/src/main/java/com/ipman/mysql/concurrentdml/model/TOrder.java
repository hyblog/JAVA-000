package com.ipman.mysql.concurrentdml.model;
...
public class TOrder {
    ...
    public String getPayErrorReason() {
        return payErrorReason;
    }

    public void setPayErrorReason(String payErrorReason) {
        this.payErrorReason = payErrorReason == null ? null : payErrorReason.trim();
    }
    ...
    public void setPayContext(String payContext) {
        this.payContext = payContext == null ? null : payContext.trim();
    }
}